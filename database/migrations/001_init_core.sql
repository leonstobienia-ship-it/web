...
CREATE INDEX idx_usuarios_perfil_principal_id ON usuarios(perfil_principal_id);
CREATE INDEX idx_perfis_company_id ON perfis(company_id);
...
CREATE UNIQUE INDEX idx_clientes_company_cpf_cnpj ON clientes(company_id, cpf_cnpj) WHERE cpf_cnpj IS NOT NULL;
CREATE UNIQUE INDEX idx_fornecedores_company_cpf_cnpj ON fornecedores(company_id, cpf_cnpj) WHERE cpf_cnpj IS NOT NULL;
CREATE INDEX idx_centros_custo_company_id ON centros_custo(company_id);
CREATE INDEX idx_obras_company_id ON obras(company_id);
CREATE INDEX idx_obras_cliente_id ON obras(cliente_id);
CREATE INDEX idx_obras_centro_custo_id ON obras(centro_custo_id);
CREATE INDEX idx_contratos_cliente_cliente_id ON contratos_cliente(cliente_id);
CREATE INDEX idx_contratos_cliente_obra_id ON contratos_cliente(obra_id);
CREATE INDEX idx_contratos_fornecedor_fornecedor_id ON contratos_fornecedor(fornecedor_id);
CREATE INDEX idx_contratos_fornecedor_obra_id ON contratos_fornecedor(obra_id);
CREATE INDEX idx_solicitacoes_compra_obra_id ON solicitacoes_compra(obra_id);
CREATE INDEX idx_solicitacoes_compra_centro_custo_id ON solicitacoes_compra(centro_custo_id);
CREATE INDEX idx_solicitacoes_compra_solicitante_id ON solicitacoes_compra(solicitante_id);
...
CREATE INDEX idx_pedidos_compra_solicitacao_id ON pedidos_compra(solicitacao_compra_id);
CREATE INDEX idx_pedidos_compra_cotacao_id ON pedidos_compra(cotacao_id);
CREATE INDEX idx_notas_fiscais_pedido_id ON notas_fiscais(pedido_compra_id);
CREATE INDEX idx_notas_fiscais_fornecedor_id ON notas_fiscais(fornecedor_id);
...
CREATE INDEX idx_contas_pagar_nota_fiscal_id ON contas_pagar(nota_fiscal_id);
...
CREATE INDEX idx_contas_receber_contrato_cliente_id ON contas_receber(contrato_cliente_id);
CREATE INDEX idx_contas_receber_medicao_obra_id ON contas_receber(medicao_obra_id);
CREATE INDEX idx_medicoes_obra_competencia ON medicoes_obra(obra_id, competencia);
CREATE INDEX idx_medicoes_obra_contrato_cliente_id ON medicoes_obra(contrato_cliente_id);
